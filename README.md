...
| `part2_frequency_table.csv` | Part 2's required output, generated by `make pipeline`. See "Part 2: frequency table" below for how `percentage` relates to relative frequency and to `total_count` |
